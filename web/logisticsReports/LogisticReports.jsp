        ...
        <script type="text/javascript">
            ...
            function gridNext(c) {
                ...
                if (b == "Next") {
                    if (a < d)
                    {
                        document.location = "nextLtReports.action?startValue=" + e + "&endValue=" + a + "&button=" + b+"&database="+db;
                    } else {
                        if (a == d) {
            ...
            function goToPage() {
                ...
                document.location = "nextLtReports.action?startValue=" + startValue + "&endValue=" + endValue + "&button=" + b+"&database="+db;
