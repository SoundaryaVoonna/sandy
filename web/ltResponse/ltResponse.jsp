        ...
        <script type="text/javascript">
            ...
            function gridNext(c) {
                ...
                if (b == "Next") {
                    if (a < d)
                    {
                        document.location = "nextLtResponse.action?startValue=" + e + "&endValue=" + a + "&button=" + b
                    } else {
                        if (a == d) {
            ...
            function goToPage() {
                ...
                document.location = "nextLtResponse.action?startValue=" + startValue + "&endValue=" + endValue + "&button=" + b
